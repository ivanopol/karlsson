<template>
    <svg id="logo_bright_park_mobile" class="logo-bright-park-mobile-svg" v-bind:class="[ theme ]" data-name="logo_bright_park_mobile" xmlns="http://www.w3.org/2000/svg" width="797.9" height="125.4" viewBox="0 0 797.9 125.4">
        ...
        <g>
            ...
            <path class="cls-1" d="M169.1,64c0-20.4,13.6-35.5,32.8-35.5c9.5-0.2,18.5,4.3,24.1,12.1V30.3h15.6v67.1H226V86.6
            ...
            <path class="cls-1" d="M667.5,30.3v10.4c5.6-7.8,14.6-12.3,24.2-12.2c19.1,0,32.6,15,32.6,35.1c0,20.4-13.6,35.5-33,35.5
            ...
            <path class="cls-1" d="M566,64c0-20.4,13.6-35.5,32.8-35.5c9.5-0.2,18.5,4.3,24.1,12.1V30.3h15.6v67.1h-15.6V86.6
            ...
            <path class="cls-1" d="M751.4,30.3V60L777,30.3h18.9l-28.2,32.1l30.1,34.9H778L751.4,66v31.3h-16.6V30.3H751.4z"/>
            <path class="cls-1" d="M300.7,30.3v37.6c0,11.5-7.8,16-15.1,16c-9.9,0-14.7-5.5-14.7-14.3V30.3h-16.7V72c0,17.6,12,26.7,26.2,26.7
            c9.2,0,15.7-4.1,21.1-10.9v9.6h15.7V30.3L300.7,30.3z"/>
            <rect x="267.8" class="st0" width="36" height="15.3"/>
            <path class="cls-1" d="M330.4,30.3h15.8v9.6c4.2-7.1,11.8-11.4,20-11.3c9.9,0,17.2,4.6,21,11.9c4.9-7.9,13.1-11.9,22.2-11.9
            ...
            <path class="cls-1" d="M42.2,29.6c-10,0-18.4,4.1-23.8,10.7V15.3H69V0H1.9v60.5c0,21.6,11.4,38.5,38.5,38.5c19.4,0,35.3-15,35.3-35.1
            ...
            <path class="cls-1" d="M476.8,0h78.4v97.3H538V16.4h-43.8v80.9h-17.3V0z"/>
        </g>
    </svg>
</template>
