<template>
    <svg id="logo_lada" class="logo-lada-svg" v-bind:class="[ theme ]" data-name="logo_lada" xmlns="http://www.w3.org/2000/svg" width="100mm" height="26.15mm" viewBox="0 0 283.46 74.12">
